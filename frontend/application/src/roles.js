...
export const Roles = {
    ...
    VO: makeEnum(['member']),
    IMS: makeEnum(['member','ims-owner','ims-manager','ims-coordinator','ims-developer']),
    BA: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    BDS: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    CAPM: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    CHM: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    COM: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    CONFM: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    CPM: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    CRM: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    CSI: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    FA: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    HR: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    ISM: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    ISRM: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    PKM: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    PM: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    PPC: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    PPM: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    RDM: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    RM: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    SACM: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    SLM: makeEnum(['member','process-owner','process-manager','process-developer','catalog-manager','sla-owner','ola-owner','ua-owner','report-owner']),
    SPM: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    SRM: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
    SUPPM: makeEnum(['member','process-owner','process-manager','process-developer','report-owner']),
};
